...
${path_cleaveland}/CleaveLand4.pl -e $path_deg/${file_name}.trimmed.21.fasta -u $path_mirna_fasta -n $transcriptome -t -o $plots/${file_name} > ${out_deg}_${file_name}

#for file_name in SRR1197125  SRR1197126 SRR1197127  SRR1197128
for file_name in SRR1197126 SRR1197127  SRR1197128
do
    mkdir $plots/${file_name}
